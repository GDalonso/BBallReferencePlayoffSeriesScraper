...
"""
keys_playoffs=['East Conf 1st Round', 'West Conf 1st Round', "East Conf Semis", "West Conf Semis", "East Conf Finals","West Conf Finals", "Finals"]
...
def fetch_all_series_urls(playoff_round_confs: bs4Tag):
    ...
    for playoff_round_conf in playoff_round_confs:
        if playoff_round_conf.string in keys_playoffs: #remove os headers
            continue
        elif playoff_round_conf.string and "Reg. Season Summary" in playoff_round_conf.string: #identifica que a lista acabou
            return urls
